...
if __name__ == "__main__":
    ...
    # constant edges
    library_e10_vertices, library_e10_times = time_and_vertices(data, 'Simple', 0)
    library_e100_vertices, library_e100_times = time_and_vertices(data, 'Simple', 50000)
    library_e1000_vertices, library_e1000_times = time_and_vertices(data, 'Simple', 100000)
    library_e10000_vertices, library_e10000_times = time_and_vertices(data, 'Simple', 150000)
    ...
    # constant vertices
    library_e10_vertices, library_e10_times = time_and_edges(data, 'Simple', 360_000)
    library_e100_vertices, library_e100_times = time_and_edges(data, 'Simple', 430_000)
    library_e1000_vertices, library_e1000_times = time_and_edges(data, 'Simple', 500_000)
    library_e10000_vertices, library_e10000_times = time_and_edges(data, 'Simple', 570_000)
